...
z2 = a1 * Theta1'; % m x s2 (# layer 2 units)
a2 = sigmoid(z2); % 
a2 = [ones(size(a2,1), 1) a2]; % Add Bias column m x s2+1 (# layer 2 units +1)
...
% Get Y in format multi class y in m x 1 and Y in m x k
...
% -backprop------------------------------------------------------------
    for i=1:m
      ...
      delta_1 = (d2' * a1(i,:)); % s2 x n+1
      delta_2 = (d3 * a2(i,:)); % k x s2 + 1
